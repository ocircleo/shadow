...
const Provider = ({ children }) => {
    ...
    useEffect(() => {
        fetch(`https://assignment-12-server-beta-tan.vercel.app/user/${user?.email}`)
            .then(res => res.json())
            .then(data => {
                setuserRole(data)
                setLoading(false)
    ...
    let authData = { user, userRole, loading, setUser, setLoading, createEmailusers, signInEmailusers, googleSignIn, updateUser, signout, userRefetch, setUserRefetch }
    return (
